...
This case is a magnitude faster than before
    ...
    OLD STR: * big array x 1.09 ops/sec Â±2.15% (7 runs sampled)
    OLD BUF: * big array x 1.23 ops/sec Â±2.67% (8 runs sampled)

    NEW STR: * big array x 273 ops/sec Â±2.09% (85 runs sampled)
    NEW BUF: * big array x 259 ops/sec Â±1.32% (85 runs sampled)
