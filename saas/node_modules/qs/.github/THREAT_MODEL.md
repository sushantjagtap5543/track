...
```
Caller Application â†’ qs.parse(input, options) â†’ Parsing Engine â†’ Output Object
                           â”‚
                           â””â†’ Options Handling

Caller Application â†’ qs.stringify(obj, options) â†’ Stringifying Engine â†’ Output String
                           â”‚
                           â””â†’ Options Handling
                           â””â†’ Cycle Tracking
```
...
|---------------------------------------|----|----|----|----|----|----|
| Public API Call (`parse`)             | â€“  | âœ“  | â€“  | âœ“  | âœ“  | âœ“  |
| Public API Call (`stringify`)         | â€“  | âœ“  | â€“  | âœ“  | âœ“  | â€“  |
| Options Handling                      | âœ“  | âœ“  | â€“  | âœ“  | â€“  | âœ“  |
| Dependency Interaction                | â€“  | â€“  | â€“  | â€“  | âœ“  | â€“  |
