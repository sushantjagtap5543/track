(function (chai, stream, module, fs) {
	...
	suite('msgpackr basic tests', function() {
		...
		test('pack/unpack large amount of chinese characters', function() {
			...
			const item = {
				message: 'ä½ å¥½ä½ å¥½ä½ å¥½ä½ å¥½ä½ å¥½ä½ å¥½ä½ å¥½ä½ å¥½ä½ å¥½', // some Chinese characters
			};
		...
		test('extended class pack/unpack', function(){
			...
			instance.value = 4;
			instance.string = 'decode this: á¾œ';
			var data = {
				prop1: 'has multi-byte: á¾œ',
		...
		test('extended Array class return self', function(){
			...
			instance.push(0);
			instance.push('has multi-byte: á¾œ');
			var data = {
				prop1: 'has multi-byte: á¾œ',
				extendedInstance: instance,
				prop2: 'more string',
		...
		test('utf16 causing expansion', function() {
			this.timeout(10000);
			let data = {fixstr: 'á¾á¾‘á¾’á¾“á¾”á¾•á¾–á¾—á¾˜á¾™á¾šá¾›á¾œá¾', str8:'á¾á¾‘á¾’á¾“á¾”á¾•á¾–á¾—á¾˜á¾™á¾šá¾›á¾œá¾á¾á¾‘á¾’á¾“á¾”á¾•á¾–á¾—á¾˜á¾™á¾šá¾›á¾œá¾á¾á¾‘á¾’á¾“á¾”á¾•á¾–á¾—á¾˜á¾™á¾šá¾›á¾œá¾á¾á¾‘á¾’á¾“á¾”á¾•á¾–á¾—á¾˜á¾™á¾šá¾›á¾œá¾á¾á¾‘á¾’á¾“á¾”á¾•á¾–á¾—á¾˜á¾™á¾šá¾›á¾œá¾á¾á¾‘á¾’á¾“á¾”á¾•á¾–á¾—á¾˜á¾™á¾šá¾›á¾œá¾á¾á¾‘á¾’á¾“á¾”á¾•á¾–á¾—á¾˜á¾™á¾šá¾›á¾œá¾á¾á¾‘á¾’á¾“á¾”á¾•á¾–á¾—á¾˜á¾™á¾šá¾›á¾œá¾á¾á¾‘á¾’á¾“á¾”á¾•á¾–á¾—á¾˜á¾™á¾šá¾›á¾œá¾á¾á¾‘á¾’á¾“á¾”á¾•á¾–á¾—á¾˜á¾™á¾šá¾›á¾œá¾á¾á¾‘á¾’á¾“á¾”á¾•á¾–á¾—á¾˜á¾™á¾šá¾›á¾œá¾á¾á¾‘á¾’á¾“á¾”á¾•á¾–á¾—á¾˜á¾™á¾šá¾›á¾œá¾á¾á¾‘á¾’á¾“á¾”á¾•á¾–á¾—á¾˜á¾™á¾šá¾›á¾œá¾á¾á¾‘á¾’á¾“á¾”á¾•á¾–á¾—á¾˜á¾™á¾šá¾›á¾œá¾á¾á¾‘á¾’á¾“á¾”á¾•á¾–á¾—á¾˜á¾™á¾šá¾›á¾œá¾á¾á¾‘á¾’á¾“á¾”á¾•á¾–á¾—á¾˜á¾™á¾šá¾›á¾œá¾'};
			var serialized = pack(data);
			var deserialized = unpack(serialized);
			assert.deepEqual(deserialized, data);
		});
