...
NIL_UUID; // â‡¨ '00000000-0000-0000-0000-000000000000'
```
...
MAX_UUID; // â‡¨ 'ffffffff-ffff-ffff-ffff-ffffffffffff'
```
...
uuidStringify(uuidBytes); // â‡¨ '6ec0bd7f-11c0-43da-975e-2a8ad9ebae0b'
```
...
uuidv1(); // â‡¨ '2c5ea4c0-4067-11e9-9bdd-2b0d7b3dcb6d'
```
...
uuidv1(options); // â‡¨ '710b962e-041c-11e1-9234-0123456789ab'
```
...
v1ToV6('92f62d9e-22c4-11ef-97e9-325096b39f47'); // â‡¨ '1ef22c49-2f62-6d9e-97e9-325096b39f47'
```
...
uuidv5('https://www.w3.org/', uuidv5.URL); // â‡¨ 'c106a26a-21bb-5538-8bf2-57095d1976c1'
```
...
uuidv6(); // â‡¨ '1e940672-c5ea-64c0-9b5d-ab8dfbbd4bed'
```
...
uuidv6(options); // â‡¨ '1e1041c7-10b9-662e-9234-0123456789ab'
```
...
v6ToV1('1ef22c49-2f62-6d9e-97e9-325096b39f47'); // â‡¨ '92f62d9e-22c4-11ef-97e9-325096b39f47'
```
...
uuidv7(); // â‡¨ '01695553-c90c-705a-b56d-778dfbbd4bed'
```
...
uuidValidate('not a UUID'); // â‡¨ false
uuidValidate('6ec0bd7f-11c0-43da-975e-2a8ad9ebae0b'); // â‡¨ true
```
...
uuidValidateV4(v4Uuid); // â‡¨ true
uuidValidateV4(v1Uuid); // â‡¨ false
```
...
uuidVersion('45637ec4-c85f-11ea-87d0-0242ac130003'); // â‡¨ 1
uuidVersion('6ec0bd7f-11c0-43da-975e-2a8ad9ebae0b'); // â‡¨ 4
```
