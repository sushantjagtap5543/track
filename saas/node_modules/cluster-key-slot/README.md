...
```text
node -v                                                                                                                                                                                               î‚² âœ” î‚² 16.38G RAM î‚² 10:29:07
v10.15.3

NEW tags x 721,445 ops/sec Â±0.44% (90 runs sampled)
OLD tags x 566,777 ops/sec Â±0.97% (96 runs sampled)
NEW without tags x 2,054,845 ops/sec Â±1.77% (92 runs sampled)
OLD without tags x 865,839 ops/sec Â±0.43% (96 runs sampled)
NEW without tags singular x 6,354,097 ops/sec Â±1.25% (94 runs sampled)
OLD without tags singular x 4,012,250 ops/sec Â±0.96% (94 runs sampled)
NEW tags (Buffer) x 552,346 ops/sec Â±1.35% (92 runs sampled)
```