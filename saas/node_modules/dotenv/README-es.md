...
>
> It serves the same purpose (you do not need to require and load dotenv), adds better debugging, and works with ANY language, framework, or platform. â€“ [motdotla](https://mot.la)
...
> El software estÃ¡ cambiando, y dotenv debe cambiar con Ã©lâ€”por eso construÃ­ [agentic secret storage (AS2)](https://dotenvx.com/as2). Los agentes ejecutan cÃ³digo sin humanos en la terminal, por lo que los archivos `.env` en texto plano son el primitivo equivocado.
>
> AS2 estÃ¡ diseÃ±ado para software autÃ³nomo: cifrado por defecto, cero acceso a consola y entrega priorizando la criptografÃ­a que mantiene a los operadores fuera del circuito.
>
> EstÃ¡ respaldado por [Vestauth](https://github.com/vestauth/vestauth), la capa de autenticaciÃ³n pionera y de confianza para agentesâ€”que otorga a cada agente una identidad criptogrÃ¡fica para firmar solicitudes con claves privadas y verificarlas con claves pÃºblicas. Sin secretos compartidos que se filtren.
>
...
Â¡Eso es todo! Este nuevo primitivo habilita el acceso a secretos para agentes sin intervenciÃ³n humana, flujos de OAuth ni claves API. Es el futuro para los agentes.
