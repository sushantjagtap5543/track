...
const languages = {
  ...
  ar: { data: ar, country: 'AE', name: '' },
  az: { data: az, country: 'AZ', name: 'Azrbaycanca' },
  bg: { data: bg, country: 'BG', name: '' },
  bn: { data: bn, country: 'IN', name: '' },
  ca: { data: ca, country: 'ES', name: 'Catal' },
  cs: { data: cs, country: 'CZ', name: 'etina' },
  de: { data: de, country: 'DE', name: 'Deutsch' },
  da: { data: da, country: 'DK', name: 'Dansk' },
  el: { data: el, country: 'GR', name: '' },
  en: { data: en, country: 'US', name: 'English' },
  es: { data: es, country: 'ES', name: 'Espaol' },
  fa: { data: fa, country: 'IR', name: '' },
  fi: { data: fi, country: 'FI', name: 'Suomi' },
  fr: { data: fr, country: 'FR', name: 'Franais' },
  gl: { data: gl, country: 'ES', name: 'Galego' },
  he: { data: he, country: 'IL', name: '' },
  hi: { data: hi, country: 'IN', name: '' },
  ...
  ja: { data: ja, country: 'JP', name: '' },
  ka: { data: ka, country: 'GE', name: '' },
  kk: { data: kk, country: 'KZ', name: '' },
  ko: { data: ko, country: 'KR', name: '' },
  km: { data: km, country: 'KH', name: '' },
  lo: { data: lo, country: 'LA', name: '' },
  lt: { data: lt, country: 'LT', name: 'Lietuvi' },
  lv: { data: lv, country: 'LV', name: 'Latvieu' },
  mk: { data: mk, country: 'MK', name: 'M' },
  ml: { data: ml, country: 'IN', name: '' },
  mn: { data: mn, country: 'MN', name: ' ' },
  ms: { data: ms, country: 'MY', name: ' ' },
  nb: { data: nb, country: 'NO', name: 'Norsk bokml' },
  ne: { data: ne, country: 'NP', name: '' },
  nl: { data: nl, country: 'NL', name: 'Nederlands' },
  nn: { data: nn, country: 'NO', name: 'Norsk nynorsk' },
  pl: { data: pl, country: 'PL', name: 'Polski' },
  pt: { data: pt, country: 'PT', name: 'Portugus' },
  pt_BR: { data: pt_BR, country: 'BR', name: 'Portugus (Brasil)' },
  ro: { data: ro, country: 'RO', name: 'Romn' },
  ru: { data: ru, country: 'RU', name: '' },
  si: { data: si, country: 'LK', name: '' },
  sk: { data: sk, country: 'SK', name: 'Slovenina' },
  sl: { data: sl, country: 'SI', name: 'Slovenina' },
  sq: { data: sq, country: 'AL', name: 'Shqipria' },
  sr: { data: sr, country: 'RS', name: 'Srpski' },
  sv: { data: sv, country: 'SE', name: 'Svenska' },
  ta: { data: ta, country: 'IN', name: '' },
  th: { data: th, country: 'TH', name: '' },
  tr: { data: tr, country: 'TR', name: 'Trke' },
  uk: { data: uk, country: 'UA', name: '' },
  uz: { data: uz, country: 'UZ', name: 'Ozbekcha' },
  vi: { data: vi, country: 'VN', name: 'Ting Vit' },
  zh: { data: zh, country: 'CN', name: '' },
  zh_TW: { data: zh_TW, country: 'TW', name: ' (Taiwan)' },
};
